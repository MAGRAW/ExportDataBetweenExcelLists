...
erCh:
    ...
    Public Sub Read_File_OUT(ByVal MyPath As String, ByVal NewName As String, ByVal i_ As Integer, _
            ByRef Nomer() As Integer, _
            ByRef SPIN(,) As Double, _
            ByRef KORblT(,) As Double, _
            ByRef X_sp(,) As Double, _
            ByRef Y_sp(,) As Double, _
            ByRef X_kor(,) As Double, _
    ...
    Public Sub ReversMergeCells(ByVal iSheet As Microsoft.Office.Interop.Excel.Worksheet, _
