...
g1:
            ...
            For j = i To UBound(Value2)
                If i <> j Then
                    If Value2(i) = Value2(j) And Value2(i) <> "Nothing" Then _
                       MsgBox("Переменная с именем " & Value2(i) & _
                              " первый раз встречается в строке " & i + 1 & _
                              ", второй раз встречается в строке " & j + 1 & _
                              ". Имена переменных должны быть уникальными." & _
    ...
    Public Sub Open_Close()
        ...
        If Trim(TextBox1.Text) <> Trim(TextBox2.Text) Then
            ...
            xlsBook1 = xlsApp.Workbooks.Open(TextBox1.Text,
                                             Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing,
                                             Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing,
                                             Type.Missing, Type.Missing, Type.Missing, True)
            'If Trim(TextBox2.Text) <> "" Then 
            'xlsBook2 = xlsApp.Workbooks.Open(TextBox2.Text) 'Открываем существующий Excel файл
            xlsBook2 = xlsApp.Workbooks.Open(TextBox2.Text,
                                             Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing,
                                             Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing,
                                             Type.Missing, Type.Missing, Type.Missing, True)
        ElseIf Trim(TextBox1.Text) = Trim(TextBox2.Text) And Trim(TextBox1.Text) <> "" And Trim(TextBox2.Text) <> "" Then
            'If Trim(TextBox1.Text) <> "" Then 
            'xlsBook1 = xlsApp.Workbooks.Open(TextBox1.Text) 'Открываем существующий Excel файл
            xlsBook1 = xlsApp.Workbooks.Open(TextBox1.Text,
                                             Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing,
    ...
    Public Sub ExcelPasteSettingFunction(ByVal iSheet As Microsoft.Office.Interop.Excel.Worksheet, _
                                         ByVal stroka As String, _
                                         ByVal PasteVariant As Integer)
        Select Case PasteVariant
            Case 1 'Вставить (А)
                'ReversMergeCells(iSheet, stroka)
                iSheet.Range(stroka).PasteSpecial(Paste:=Microsoft.Office.Interop.Excel.XlPasteType.xlPasteAll, _
                                                                           Operation:=Microsoft.Office.Interop.Excel.XlPasteSpecialOperation.xlPasteSpecialOperationNone, _
                                                                           SkipBlanks:=False, Transpose:=False)
                'ReversMergeCells(iSheet, stroka)
            Case 2 'Значения (З)
                iSheet.Range(stroka).PasteSpecial(Paste:=Microsoft.Office.Interop.Excel.XlPasteType.xlPasteValues, _
                                                                           Operation:=Microsoft.Office.Interop.Excel.XlPasteSpecialOperation.xlPasteSpecialOperationNone, _
                                                                           SkipBlanks:=False, Transpose:=False)
            Case 3 'Формулы (Ф)
                iSheet.Range(stroka).PasteSpecial(Paste:=Microsoft.Office.Interop.Excel.XlPasteType.xlPasteFormulas, _
                                                                           Operation:=Microsoft.Office.Interop.Excel.XlPasteSpecialOperation.xlPasteSpecialOperationNone, _
                                                                           SkipBlanks:=False, Transpose:=False)
            ...
            Case 5 'Форматирование (Ф)
                iSheet.Range(stroka).PasteSpecial(Paste:=Microsoft.Office.Interop.Excel.XlPasteType.xlPasteFormats, _
                                                                           Operation:=Microsoft.Office.Interop.Excel.XlPasteSpecialOperation.xlPasteSpecialOperationNone, _
                                                                           SkipBlanks:=False, Transpose:=False)
            Case 6 'Вставить связь (Ь)
                iSheet.Range(stroka).PasteSpecial(Paste:=Microsoft.Office.Interop.Excel.XlPasteType.xlPasteValidation, _
                                                                           Operation:=Microsoft.Office.Interop.Excel.XlPasteSpecialOperation.xlPasteSpecialOperationNone, _
                                                                           SkipBlanks:=False, Transpose:=False)
        End Select
    End Sub
    ...
    Public Sub GetLinkOfVariable(ByVal j As Integer, ByRef iLink As Object)
        ...
        iLink = "'" & _
                Mid(AdresFrom, 1, InStrRev(AdresFrom, "\") - 1) & Replace(AdresFrom, "\", "\[", InStrRev(AdresFrom, "\")) & _
                "]" & _
                Sheet_from & _
                "'!" & _
                Ceels_from
    ...
    Public Sub LoadDataRichTextBox()
        ...
        If My.Computer.FileSystem.FileExists(adres1) = True And _
           My.Computer.FileSystem.FileExists(adres2) = True Then
            If NameLR <> "" Then TextBox4.Text = NameLR 'печать имени шаблона 
        ElseIf My.Computer.FileSystem.FileExists(adres1) = False And _
    ...
    Public Sub ReadMyBase(ByVal adres As String, _
                          ByRef txt1() As String, _
                          ByRef txt2() As String, _
                          ByRef txt3() As String, _
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        If RichTextBox3.Text <> "" And RichTextBox4.Text <> "" And RichTextBox5.Text <> "" And _
           RichTextBox6.Text <> "" And RichTextBox7.Text <> "" And RichTextBox8.Text <> "" Then
            ...
            FileClose(hFile4)
            RichTextBox9.Text = "" : RichTextBox10.Text = ""
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        If Trim(RichTextBox3.Text) <> "" And Trim(RichTextBox4.Text) <> "" And Trim(RichTextBox5.Text) <> "" And _
           Trim(RichTextBox6.Text) <> "" And Trim(RichTextBox7.Text) <> "" And Trim(RichTextBox8.Text) <> "" Then

            'ВХОДНЫЕ ССЫЛКИ
            iBaseReplace(adres1, _
                         RichTextBox3.Text, _
                         RichTextBox4.Text, _
                         RichTextBox5.Text, _
                         Val(Trim(Label10.Text)), _
                         Val(Trim(TextBox3.Text)))
            RichTextBox3.Text = "" : RichTextBox4.Text = "" : RichTextBox5.Text = ""

            'ВЫХОДНЫЕ ССЫЛКИ
            iBaseReplace(adres2, _
                         RichTextBox6.Text, _
                         RichTextBox7.Text, _
                         RichTextBox8.Text, _
                         Val(Trim(Label10.Text)), _
    ...
    Public Sub iBaseReplace(ByVal adres As String, _
                            ByVal Text1 As String, _
                            ByVal Text2 As String, _
                            ByVal Text3 As String, _
                            ByVal iGindex As Integer, _
    ...
    Public Sub iObjectResizeSize(ByRef iObject_Parent As Object, ByRef iObject_Child As Object, _
                                 ByVal X_Parent As Object, ByVal X_Child As Object, _
